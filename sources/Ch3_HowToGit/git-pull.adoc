...
image::ch3/git-pull-before.jpg[紅莉栖が作業している, 380]
endif::[]
...
ifeval::["{backend}" != "html5"]
image::ch3/git-pull-select.jpg[pull してくるブランチを選んでいる状態, 380]
endif::[]
...
ifeval::["{backend}" != "html5"]
image::ch3/git-pull-after.jpg[自分の PC 上のリポジトリとリモートリポジトリの同期をとった, 380]
endif::[]
