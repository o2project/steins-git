...
image::ch3/git-checkout.jpg[ブランチを移動した後, 380]
endif::[]
...
ifeval::["{backend}" != "html5"]
image::ch3/git-checkout/github-app/git-branch-list.jpg[ブランチ一覧を表示している図, 380]
endif::[]
...
ifeval::["{backend}" != "html5"]
image::ch3/git-checkout/github-app/git-checkout-after.jpg[ブランチを移動した後の図, 380]
endif::[]
