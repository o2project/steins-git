...
image::img/google-trend.jpg[Googleトレンド, 460]
...
image::img/qiita-svn.jpg[QiitaでSVNを検索した結果, 350]
...
image::img/qiita-git.jpg[QiitaでGitを検索した結果, 300]
...
image::img/stackoverflow-svn.jpg[Stack OverflowでSVNを検索した結果, 460]

次に、Gitを検索した結果です。SVNに比べ、タグが付けられた数が2倍以上となっています。

image::img/stackoverflow-git.jpg[Stack OverflowでGitを検索した結果, 460]
