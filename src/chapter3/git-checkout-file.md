...
![作業内容を無かった事にする](/images/ch3/git-checkout-file/source-tree/before.jpg)

変更を本当に破棄していいか確認の画面が表示されるので「OK」を押します。

![作業内容を無かった事にするか確認がされる](/images/ch3/git-checkout-file/source-tree/confirm.jpg)

これで、紅莉栖に論破されたという事が無くなりました。

![論破された事を無くした後](/images/ch3/git-checkout-file/source-tree/after.jpg)
